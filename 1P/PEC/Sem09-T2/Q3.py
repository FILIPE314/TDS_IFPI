...
def main():
    ...
    data = int(input('Digite uma data nessse formato DDMMAAAA para que possa ser verificada se essa data é verdadeira ou falsa:'))
    # acionando a função e imprimindo
    print('Sua data é:',separar_data(data))

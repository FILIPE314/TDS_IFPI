...
def main():
    ...
    print('Abaixo digite sua matrícula e depois suas 3 notas para saber a média e se foi aprovado.')
    # variável que imprime uma informação na tela e armazena dados
    matricula = input('Digite aqui sua matrícula:')
    # variável que imprime uma informação na tela e armazena dados
    num1 = float(input('Aqui digite sua primeira nota:'))
    # variável que imprime uma informação na tela e armazena dados
    num2 = float(input('Aqui digite sua segunda nota:'))
    # variável que imprime uma informação na tela e armazena dados
    num3 = float(input('Aqui digite sua terceira nota:'))
    # variável que imprime uma informação na tela e armazena dados
    media = float(input('Aqui digite sua média dessas 3 notas:'))
    ...
    # imprime oque tem na variável
    print('Uma atribuição para sua média',result)
    # aciona a função
    print(f'Você foi {media_final2(result)}')
